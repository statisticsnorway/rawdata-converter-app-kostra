...
build-docker: ## Build the docker image
	docker build -t rawdata-converter-app-kostra:dev -f Dockerfile .
...
run-local: ## Run the app locally (without docker)
	MICRONAUT_ENVIRONMENTS=local MICRONAUT_CONFIG_FILES=conf/bootstrap.yml,conf/application-local.yml java -Dcom.sun.management.jmxremote -jar  target/rawdata-converter-app-*.jar
